  ...
  return (
    <div>
      ...
      <div className="progress" style={{height: 30}}>
        <div className={"fs-5 progress-bar text-dark fw-bold " + (50 > props.health ? (20 > props.health ? 'bg-danger' : 'bg-warning') : 'bg-success')} role="progressbar" style={{width: `${props.health}%`}} aria-valuenow={props.health} aria-valuemin="0" aria-valuemax="100">{props.health}/100 HP</div>
      </div>
    </div>
  )
}