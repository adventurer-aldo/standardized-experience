class Subject < ApplicationRecord
  ...
  has_many :challenges, class_name: 'Challenge', foreign_key: 'subject_id', dependent: :destroy
  has_many :lessons, class_name: 'Lesson', foreign_key: 'subject_id', dependent: :destroy
