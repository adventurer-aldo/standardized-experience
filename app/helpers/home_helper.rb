      ...
      content_tag(:tbody,
                  journey.chairs.order(id: :asc).collect { |chair|
                    ...
                    content_tag(:tr,
                                ...
                                content_tag(:td, (journey.level > 2 && (chair.first.nil? || chair.second.nil?) ? (chair.reposition.nil? ? '---' : chair.reposition.to_s.gsub('.',',')) : '---'), class: 'text-center') +
                                ...
                                (((chair.first || 0) + (chair.second || 0)) / 2 == 20 ? content_tag(:td, chair.extraordinary.nil? ? '---' : chair.extraordinary.to_s.gsub('.',','), class: 'text-center') :
