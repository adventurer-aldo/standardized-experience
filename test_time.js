...
// Update the count down every 1 second
  ...
  if (distance < 0) {
    ...
    document.getElementById('test1').src='audio/rushtest1.mp3'; 
    document.getElementById('test2').src='audio/rushtest2.mp3'; 
    document.getElementById('exam').src='audio/rushexam.mp3'; 
    document.getElementById('examrec').src='audio/rushexam.mp3'; 
