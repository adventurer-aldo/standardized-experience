<?php
    ...
    foreach ($lines as $line) {
        ...
        if (substr(trim($line), -1, 1) == ';') { 
            pg_query(pg_connect("username=host=ec2-52-208-145-55.eu-west-1.compute.amazonaws.com, user=jxjrhhnsbrdceq, password=26ef405f573a3c924900cf77a5fa8dc7d6a9e73499724dd79ab8bdd0bd475f93, database=d3jdf665veionf"),$templine);
            $templine = '';
        };
    };
    // Check connection
