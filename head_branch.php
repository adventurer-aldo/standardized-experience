...
<?php $_SESSION['subjecto'] = pg_fetch_assoc(pg_query($conn,"SELECT * FROM (SELECT DISTINCT subject FROM quiz) AS ratatat ORDER BY RANDOM() LIMIT 1"));echo $_SESSION['subjecto'];?>
        <ul id="lisuto">
